 ...
 */
public class LimelightHelpersCameronEdition {
    ...
    public static class PoseEstimate {
        ...
        public PoseEstimate(Pose2d pose, double timestampSeconds, double latency, 
            ...
            double avgTagArea, RawFiducial[] rawFiducials, boolean isMegaTag2, double[] std) {
    ...
    public static Pose2d toPose2D(double[] inData){
     ...
     /**
     * Takes a 6-length array of pose data and converts it to a 3-length array of pose data.
     * Uses only x, y, and yaw components, ignoring z, roll, and pitch.
     * Array format: [x, y, z, roll, pitch, yaw] where angles are in degrees.
     * @param inData Array containing pose data [x, y, z, roll, pitch, yaw]
     * @return Array representing the [x, y, yaw], or empty Pose2d if invalid data
     */
    public static double[] toArray2D(double[] inData){
        if(inData.length < 6)
        {
            //System.err.println("Bad LL 2D Pose Data!");
            return new double[6];
        ...
        double[] output = {inData[0], inData[1], inData[5]};
        return output;
    }
    ...
    private static PoseEstimate getBotPoseEstimate(String limelightName, String entryName, boolean isMegaTag2) {
        ...
        return new PoseEstimate(pose, adjustedTimestamp, latency, tagCount, tagSpan, tagDist, tagArea, rawFiducials, isMegaTag2, std);
    }
    ...
    public static RawFiducial[] getRawFiducials(String limelightName) {
        var entry = LimelightHelpersCameronEdition.getLimelightNTTableEntry(limelightName, "rawfiducials");
    ...
    public static RawDetection[] getRawDetections(String limelightName) {
        var entry = LimelightHelpersCameronEdition.getLimelightNTTableEntry(limelightName, "rawdetections");
    ...
    public static LimelightResults getLatestResults(String limelightName) {
        ...
        LimelightHelpersCameronEdition.LimelightResults results = new LimelightHelpersCameronEdition.LimelightResults();
        if (mapper == null) {
